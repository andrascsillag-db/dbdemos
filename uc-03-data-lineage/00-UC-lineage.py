...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=3679152566148441&notebook=%2F00-UC-lineage&demo_name=uc-03-data-lineage&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-03-data-lineage%2F00-UC-lineage&version=1">

# COMMAND ----------

# MAGIC %md 
# MAGIC ### A cluster has been created for this demo
# MAGIC To run this demo, just select the cluster `dbdemos-uc-03-data-lineage-andras_csillag` from the dropdown menu ([open cluster configuration](https://adb-3679152566148441.1.azuredatabricks.net/#setting/clusters/0219-115935-ge5kkdo4/configuration)). <br />
