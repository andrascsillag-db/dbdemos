...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=3679152566148441&notebook=%2F02-%5Blegacy%5D-UC-Dynamic-view&demo_name=uc-01-acl&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-01-acl%2F02-%5Blegacy%5D-UC-Dynamic-view&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-uc-01-acl-andras_csillag` from the dropdown menu ([open cluster configuration](https://adb-3679152566148441.1.azuredatabricks.net/#setting/clusters/0219-120003-lw2b9qb7/configuration)). <br />
