...
-- MAGIC To run this demo, just select the cluster `dbdemos-dlt-loans-andras_csillag` from the dropdown menu ([open cluster configuration](https://adb-3679152566148441.1.azuredatabricks.net/#setting/clusters/1214-163654-2n9cwa46/configuration)). <br />
...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3679152566148441&notebook=%2F03-Log-Analysis&demo_name=dlt-loans&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F03-Log-Analysis&version=1">
...
-- MAGIC %md
-- MAGIC Your expectations are ready to be queried in SQL! Open the <a href="/sql/dashboards/24dae071-b562-448a-aa6b-f25f73c5f595" target="_blank">data Quality Dashboard example</a> for more details.