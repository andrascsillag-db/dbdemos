...
# MAGIC
# MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/09dad962-680b-457c-aab2-e1708cba9534">available here</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=3679152566148441&notebook=%2F02-DLT-Loan-pipeline-PYTHON&demo_name=dlt-loans&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F02-DLT-Loan-pipeline-PYTHON&version=1">
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/09dad962-680b-457c-aab2-e1708cba9534">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
...
# MAGIC
# MAGIC <a href="/sql/dashboards/24dae071-b562-448a-aa6b-f25f73c5f595" target="_blank">Data Quality Dashboard example</a>